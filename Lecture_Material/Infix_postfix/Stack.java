...
public class Stack {
	...
	//checking if char is an operator
	...
	public String infix_postfix(String infix)
	{
	   	...
	   	for(i=0;i<infix.length();i++)
	   	{
	   		...
	   		//If char is operant add to postfix string:
	   		if(isOperant(ch))  
	   		{
	   			postfix += ch;	   			
	   		}
	   	...
	   	//when string terminates pop all operators from stack & add to postfix
	   	while(!isEmpty())
	   	{
	   		ch = pop();
	   		if(ch=='(' || ch==')')
